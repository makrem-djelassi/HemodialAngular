  ...
  implements OnInit
{
  ...
  changeCategory(event: MatCheckboxChange, filter: any) {
    if (event.checked) {
  ...
  editEvent(eventIndex: any, calendarData: any) {
  ...
  createCalendarForm(calendar: any): UntypedFormGroup {
  ...
  getClassNameValue(category: any) {
    let className: any;
